                ...
                <ul class="menu__box">
                    ...
                    <li>
                        <form class="" action="../index.php" method="POST">
                            <button class="fs-3 btn-lg btn p-5" type="submit" value="accueil">Retour</button>
                        </form>
                    </li>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Faite plaisr</h5>
        ...
        <div class="card mb-3 " style="max-width: 1500px;">
            <?php foreach ($arrayCat as $cat) { ?>
                <div class="row g-0 border border-dark mb-5">
                    <div class="col-md-4">
                        <img src="../assets/img/<?= $cat["pictureCat"] ?>" class="px-4 mx-auto m-4 img-fluid photoCardCatArray" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h1 class="card-title text-center"><?= $cat["nameCat"] ?></h1>
                            <p class="text-center p-5 fs-4"><?= $cat["introCat"] ?></p>
                        </div>

                    </div>
                    <div class="wrap">
                        <form class="text-center" action="../views/prestations.php?category=<?= $cat["idCat"] ?>" method="POST">

                            <button class="btn-lg btns btn " href="../views/prestations.php?category=<?= $cat["idCat"] ?>">Acceder aux soins</button>
                        </form>
                    </div>
