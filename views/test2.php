...
<body class="card">
    ...
    <div class="row d-flex justify-content-center mt-4">
        <h1 class="col-lg m-5 text-center"> Découvrez ici toutes les catégories proposées</h1>
    </div>
    <!-- CARDS -->
        ...
        <div class="card mb-3 " style="max-width: 1600px;">
            <?php foreach ($arrayCat as $cat) { ?>
                <div class="row g-0 border border-dark mb-5">
                    <div class="col-md-4">
                        <img src="../assets/img/<?= $cat["pictureCat"] ?>" class=" img-fluid mx-auto border border-dark photoCardCatArray" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h1 class="fs-1 card-title"><?= $cat["nameCat"] ?></h1>
                            <p class="fs-3 card-text"><?= $cat["introCat"] ?></p>
                        </div>
                    </div>
                    <div class="wrap">
                        <form class="text-center m-4" action="test.php?category=<?= $cat["idCat"] ?>" method="POST">
                            <button class="btn-sm btni m-4" href="test.php?category=<?= $cat["idCat"] ?>">Acceder aux soins</button>
                        </form>
                    </div>
                </div>
        </div>
