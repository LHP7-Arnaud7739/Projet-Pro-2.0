            ...
            <?php foreach ($arrayCat as $cat) { ?>
                <div class="col">
                    <div class="p-4 shadow text-center card">
                        ...
                        <form class="text-center" action="prestations.php?category=<?= $cat["idCat"] ?>" method="POST">

                            <button class="btn-lg btns btn " href="prestations.php?category=<?= $cat["idCat"] ?>">Acceder aux soins</button>
                        </form>
                        </div>
                    </div>
                </div>
