...
<body class="card">
    ...
    <div class="p-5 col m-4">
        <?php if (!empty($_SESSION)) {  ?>
            <p class="fs-1 text-center ">Bonjour <b class="fs-1 text-danger"> <?= "" . $_SESSION['login'] ?></b></p>
    </div>
<?php } ?>
        ...
        <div class="text-center card">
            ...
            <?php if (empty($_SESSION["login"])) { ?>
                ...
                <form class="text-center" action="../index.php" method="POST">
                    <button class="btn-lg btni btn " href="../index.php">Accueil</button>
                </form>
            </div>
            <div class="card-body">
                <?php if (empty($_SESSION["login"])) { ?>
